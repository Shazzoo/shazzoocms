...
function MenuEditor(idSelector, options) {
    ...
    function TButtonGroup() {
        ...
        var $btnRemv = TButton({classCss: 'btn btn-danger text-white  btn-xs btnRemove', text:'<i class=" text-white fa-solid fa-trash clickable"></i>'});
    ...
    function createMenu(arrayItem, depth) {
        ...
        $.each(arrayItem, function (k, v) {
            ...
            $i.addClass('fa-fw text-black clickable');
