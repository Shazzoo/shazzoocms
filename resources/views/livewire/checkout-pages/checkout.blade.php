<div>
    ...
    <div class="grid sm:px-10 lg:grid-cols-3 lg:px-20 xl:px-32 dark:bg-gray-800 ">
        ...
        <div class="px-4 pt-8 mt-10 bg-white dark:bg-gray-800 lg:mt-0">
            ...
            @if ($ShippingMethodType != 'Local_pickup')
            <livewire:checkout-pages.payments-methods>
                ...
                <button wire:click='Place_order' class="w-full px-6 py-3 mt-4 mb-8 font-medium text-white bg-gray-900 rounded-md
                    ...
                    disabled @endif @else @if ( $ShippingAddress==null || $BillingAddress==null || $ShippingMethod==null
                    || $TotalPrice==null) bg-gray-400 cursor-not-allowed @endif" @if ( $BillingAddress==null ||
                    $ShippingAddress==null || $ShippingMethod==null || $TotalPrice==null) disabled @endif @endif>Place
                    Order</button>
        </div>
    </div>
</div>