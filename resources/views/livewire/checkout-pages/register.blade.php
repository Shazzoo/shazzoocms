...
@script
    <script>
        window.addEventListener('swal', function(e) {
            Swal.fire({
                title: 'U had eerder een bestiling gemaakt met dit emailadres, wilt u een account aanmaken?',
                showDenyButton: true,
                ...
                if (result.isConfirmed) {
                    Swal.fire(
                        'We hebben alle u gegevens u kijgt een email om een wachtwoord aan te maken ',
                        '', 'info'
                    ).then((result) => {
                        if (result.isConfirmed) {
        ...
        window.addEventListener('swal_login', function(e) {
            Swal.fire({
                title: 'U bent een gebruiker u kunt inlogen anders gebruik een andere email om in te logen klik op ja om door te gaan',
                showDenyButton: true,
                confirmButtonText: 'Ja',
                denyButtonText: 'Nee',
                icon: 'warning',
        ...
        window.addEventListener('swal_success', function(e) {
            Swal.fire({
                title: 'Uw gegevens zijn opgeslagen ',
                text: 'U krijgt een email om een wachtwoord aan te maken',
                icon: 'success',
                allowOutsideClick: false
            }).then((result) => {
                if (result.isConfirmed) {
