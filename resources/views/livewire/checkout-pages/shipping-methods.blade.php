<div class="grid gap-6 mt-6">
    ...
    @else
        ...
        <div class="relative" wire:key='shippingMethod_{{ $shippingMethod->id }}'  @if ($paymentMethodcount == 0  &&  $shippingMethod->type !="Local_pickup" )
            hidden

            @elseif ($shippingMethod->type == 'Free' && $shippingMethod->min_order_amount > $totalprice  )
            hidden
            @endif
