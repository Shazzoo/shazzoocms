<div
    ...
    <div class="p-5">
        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div class="col-span-2 sm:col-span-1">
                <label for="password" class="block text-sm font-medium text-gray-700 dark:text-white">Password (leave
            ...
            <div class="col-span-2 sm:col-span-1">
                ...
                <select id="encryption" wire:model="encryption" class="block dark:text-white w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500">
