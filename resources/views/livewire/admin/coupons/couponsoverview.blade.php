    ...
    <div class="p-5">
        <header class="flex flex-col gap-3 px-6 py-4 fi-section-header">
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.create.coupons') }}"
        ...
        <div
                        ...
                        <div class="fi-ta-search-field">
                            ...
                            <div
                                ...
                                <div class="flex-1 min-w-0">
                                    <input
                                        class="fi-input block w-full bcoupon-none py-1.5 text-base text-gray-950 transition duration-75 placeholder:text-gray-400 focus:ring-0 disabled:text-gray-500 disabled:[-webkit-text-fill-color:theme(colors.gray.500)] disabled:placeholder:[-webkit-text-fill-color:theme(colors.gray.400)] dark:text-white dark:placeholder:text-gray-500 dark:disabled:text-gray-400 dark:disabled:[-webkit-text-fill-color:theme(colors.gray.400)] dark:disabled:placeholder:[-webkit-text-fill-color:theme(colors.gray.500)] sm:text-sm sm:leading-6 bg-white/0 ps-0 pe-3"
            ...
            <div
                class="relative overflow-x-auto divide-y divide-gray-200 fi-ta-content dark:divide-white/10 dark:bcoupon-t-white/10">
                <table class="w-full divide-y divide-gray-200 table-auto fi-ta-table text-start dark:divide-white/5">
                    <thead class="divide-y divide-gray-200 dark:divide-white/5">
                        <tr class="bg-gray-50 dark:bg-white/5">
                         

                            <th class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 fi-table-header-cell-coupon.name"
                                style=";">
                    ...
                    <tbody class="divide-y divide-gray-200 whitespace-nowrap dark:divide-white/5">
                        ...
                        <tr
                            ...
                            <td
                                class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-coupon.name">
                                                ...
                                                <div class="grid w-full px-3 py-4 fi-ta-text gap-y-1">
                                                    <div class="flex">
                                                        <div class="flex max-w-max" style>
                                                            <div class="fi-ta-text-item inline-flex items-center gap-1.5">
                                                                <span class="text-sm leading-6 fi-ta-text-item-label text-gray-950 dark:text-white" style>
                                                                  %  {{ number_format($coupon->percentage, 0) }}
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <td
                                ...
                                <div
                                    ...
                                    <a href="{{ route('admin.edit.coupons', $coupon) }}"
                                    ...
                                    <a wire:click='deleteCoupon({{ $coupon->id }})'
                                        class="relative inline-flex items-center justify-center gap-1 outline-none cursor-pointer btn fi-link group/link fi-size-sm fi-link-size-sm fi-color-custom fi-color-primary fi-ac-action fi-ac-link-action">
