    ...
    <div class="p-5">
        <header class="flex flex-col gap-3 px-6 py-4 fi-section-header">
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.create.prodcuts') }}"
       ...
       <div
        ...
        <div class="divide-y divide-gray-200 fi-ta-header-ctn dark:divide-white/10">
                ...
                <div class="flex items-center shrink-0 gap-x-4">
                    <div>
                        <div class="items-center gap-x-3 sm:flex">
                            <label>
                                <div
                                    class="flex transition duration-75 bg-white rounded-lg shadow-sm fi-input-wrp ring-1 dark:bg-white/5 focus-within:ring-2 ring-gray-950/10 dark:ring-white/20 focus-within:ring-primary-600 dark:focus-within:ring-primary-500">
                                    <div class="flex-1 min-w-0">
                                        <select
                                            class="fi-select-input block w-full border-none bg-transparent py-1.5 pe-8 text-base text-gray-950 transition duration-75 focus:ring-0 disabled:text-gray-500 dark:text-white dark:disabled:text-gray-400 sm:text-sm sm:leading-6 ps-3"
                    ...
                    <div class="flex items-center ms-auto gap-x-4">
                        ...
                        <div class="fi-ta-search-field">
                            ...
                            <div
                                ...
                                <div class="flex-1 min-w-0">
                                    <input
                                        class="fi-input block w-full bproduct-none py-1.5 text-base text-gray-950 transition duration-75 placeholder:text-gray-400 focus:ring-0 disabled:text-gray-500 disabled:[-webkit-text-fill-color:theme(colors.gray.500)] disabled:placeholder:[-webkit-text-fill-color:theme(colors.gray.400)] dark:text-white dark:placeholder:text-gray-500 dark:disabled:text-gray-400 dark:disabled:[-webkit-text-fill-color:theme(colors.gray.400)] dark:disabled:placeholder:[-webkit-text-fill-color:theme(colors.gray.500)] sm:text-sm sm:leading-6 bg-white/0 ps-0 pe-3"
            ...
            <div
                class="relative overflow-x-auto divide-y divide-gray-200 fi-ta-content dark:divide-white/10 dark:bproduct-t-white/10">
                <table class="w-full divide-y divide-gray-200 table-auto fi-ta-table text-start dark:divide-white/5">
                    <thead class="divide-y divide-gray-200 dark:divide-white/5">
                        <tr class="bg-gray-50 dark:bg-white/5">
                            ...
                            <th class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 fi-table-header-cell-product.name"
                                style=";">
                                <div class="flex items-center justify-start w-full group gap-x-1 whitespace-nowrap">
                                    <span
                                        class="text-sm font-semibold fi-ta-header-cell-label text-gray-950 dark:text-white">
                    ...
                    <tbody class="divide-y divide-gray-200 whitespace-nowrap dark:divide-white/5">
                        @foreach ($products as $product)
                            <tr
                                ...
                                <td
                                    class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-product.name">
                                    <div class="fi-ta-col-wrp">
                                        <div class="flex justify-start w-full disabled:pointer-events-none text-start">
                                            <div class="grid w-full px-3 py-4 fi-ta-text gap-y-1">
                                                <div class="flex">
                                ...
                                <td
                                    class="p-0 fi-ta-cell first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-total-price">
                                    <div class="fi-ta-col-wrp">
                                        <div class="flex justify-start w-full disabled:pointer-events-none text-start">
                                            <div class="grid w-full px-3 py-4 fi-ta-text gap-y-1">
                                                <div class="flex">
                                                    <div class="flex max-w-max" style>
                                                        <div class="fi-ta-text
                                                            ...
                                                            <span
                                                                class="text-sm leading-6 fi-ta-text-item-label text-gray-950 dark:text-white"
                                                                style>
{{ $product->category ? $product->category->name : 'No Category' }}                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <td
                                    ...
                                    <div
                                        ...
                                        <a href="{{ route('admin.edit.prodcuts', $product->id) }}"
                                        ...
                                        <a wire:click='conformDelete({{ $product->id }})'
class="relative inline-flex items-center justify-center gap-1 outline-none cursor-pointer fi-link group/link fi-size-sm fi-link-size-sm fi-color-custom fi-color-primary fi-ac-action fi-ac-link-action">                                            <svg style="--c-400:#dc2626;--c-600:#dc2626;"
                                                class="w-4 h-4 fi-link-icon text-custom-600 dark:text-custom-400"
                                            ...
                                            <span
class="text-sm font-semibold group-hover/link:underline group-focus-visible/link:underline text-custom-600 dark:text-custom-400"                                                style="color:#dc2626">
                                                Delete
                                            </span>
                                        </a>
                                    </div>
