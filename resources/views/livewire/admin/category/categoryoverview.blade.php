                        ...
                        <tr
                            ...
                            <td
                                ...
                                <div
                                    ...
                                    <a wire:click='deleteCategory({{ $category->id }})' class="relative inline-flex items-center justify-center gap-1 outline-none cursor-pointer fi-link group/link fi-size-sm fi-link-size-sm fi-color-custom fi-color-primary fi-ac-action fi-ac-link-action"> <svg
