    ...
    <div class="p-5">
        ...
        <div class="grid grid-cols-2 gap-6">
            <div class="col-span-2 sm:col-span-1">
                <label for="name" class="block text-sm font-medium text-gray-700 dark:text-white">Category
                    Name</label>
        ...
        <div class="flex justify-end mt-6">
            <button wire:click="saveNewCategory" class="p-2 rounded-md dark:bg-gray-800 fi-btn fi-btn-primary">
                Add Category
            </button>
        </div>
